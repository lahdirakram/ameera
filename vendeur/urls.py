...
urlpatterns = [
	...
	re_path(r'^ajoutproduit/$', views.ajoutproduit, name="ajoutproduit"),
	re_path(r'^supprimerproduit/$', views.supprimerproduit, name="supprimerproduit"),
	re_path(r'^modifierproduit/$', views.modifierproduit, name="modifierproduit"),
	...
	re_path(r'^testeur/$', views.testeur_in, name="testeur"),
